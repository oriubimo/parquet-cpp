...
if (PARQUET_BOOST_USE_SHARED)
  ...
  if (MSVC)
    ...
    find_package(Boost 1.65.1 EXACT COMPONENTS regex system REQUIRED)
  else()
    find_package(Boost 1.65.1 EXACT COMPONENTS regex system REQUIRED)
  endif()
  ...
  if (MSVC)
    find_package(Boost 1.65.1 EXACT COMPONENTS regex system filesystem REQUIRED)
  else()
    find_package(Boost 1.65.1 EXACT COMPONENTS regex REQUIRED)
  endif()
  if ("${UPPERCASE_BUILD_TYPE}" STREQUAL "DEBUG")
